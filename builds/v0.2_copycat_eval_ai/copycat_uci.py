#!/usr/bin/env python
# copycat_uci.py - UCI launcher for Copycat Chess Engine v0.2
import sys
import os
import chess
import time
...
class UCIEngine:
    def __init__(self):
        self.name = "Copycat Chess Engine v0.2 Evaluation"
...
def main():
    """Launch the Copycat Chess Engine v0.2 in UCI mode"""
    try:
        engine = UCIEngine()
        engine.run()
    except Exception as e:
