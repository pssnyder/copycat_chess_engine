@echo off
REM Build script for Copycat Chess Engine v0.2 Evaluation AI
REM This script creates a standalone executable for Arena chess GUI compatibility

echo ========================================
echo Building Copycat Chess Engine v0.2 Evaluation AI
echo ========================================

REM Set build configuration
set VERSION=v0.2
set ENGINE_NAME=CopycatChessEngine_v0.2_Eval
